...
# 定义添加高斯噪声
def inject_gaussian_noise(points_with_normals, mean=0, std=0.025):
    noise = np.random.normal(mean, std, points_with_normals.shape)
    return points_with_normals + noise
